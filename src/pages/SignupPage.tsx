...
export default function SignupPage() {
  ...
  const handlePhoneSubmit = async (e: React.FormEvent) => {
    ...
    navigate('/verify-phone', {
      replace: true,
      state: { phone, name: name.trim(), mode: 'signup' },
    })
  }
          ...
          {method === 'email' ? (
            <form onSubmit={handleEmailSubmit} className="space-y-5">
              ...
              <p className="text-xs text-white/40">
                We&apos;ll send a verification email. Check your inbox and spam folder. You can also
            ...
            <form onSubmit={handlePhoneSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-white/40">
                  No email needed. We&apos;ll verify you with a 6-digit SMS code.
                </p>
              </div>
              <Button type="submit" className="w-full" variant="highlight" disabled={loading}>
                {loading ? (
